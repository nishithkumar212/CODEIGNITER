...
$query="SELECT n.title,n.labelid,n.notesimage,n.description,n.reminder,n.color,n.id,l.labelname from notes n Left JOIN label_notes ln ON ln.noteid=n.id left JOIN labels l on ln.labelid=l.id where n.uid = '$email' AND n.archive='0' AND n.unactive='0'";
